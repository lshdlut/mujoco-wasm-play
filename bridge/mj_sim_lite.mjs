...
export class MjSimLite {
  ...
  jntGroupView(){ const m=this.mod; const nj=this.njnt()|0; if(!(nj>0)) return null; const p=this._cachedPtr('_mjwf_model_jnt_group_ptr')|0; if(!p)return null; return heapViewI32(m,p,nj); }
