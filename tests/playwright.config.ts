...
const serveScript = JSON.stringify(path.join(devRoot, "node_modules", "serve", "build", "main.js"));
const webServerCommand = `${nodeExec} ${serveScript} ${JSON.stringify(devRoot)} -l ${port} --no-clipboard`;
