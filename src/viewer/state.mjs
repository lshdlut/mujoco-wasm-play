...
const WORKER_URL = new URL('../../local_tools/viewer_demo/physics.worker.mjs', import.meta.url);
const DIRECT_URL = new URL('../../local_tools/viewer_demo/direct_backend.mjs', import.meta.url);
...
<mujoco model='empty'>
  ...
  <worldbody>
    ...
    for (const candidate of candidates) {
      ...
      seen.add(file);
      try {
        const url = new URL(`../../local_tools/viewer_demo/${file}`, import.meta.url);
