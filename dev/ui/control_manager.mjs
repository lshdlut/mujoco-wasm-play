...
import { isStrictEnabled, logDebug, logWarn, logStatus, logError, strictCatch, strictEnsure, strictOverride } from '../viewer_runtime.mjs';
import { DEFAULT_REALTIME_INDEX, DEFAULT_VOPT_FLAGS, REALTIME_LEVELS, SCENE_FLAG_DEFAULTS } from '../viewer_defaults.mjs';
import { assignStructPath, bool, cloneStruct, createDefaultHistoryState, createDefaultKeyframeState, createDefaultWatchState, createViewerGroupState, normaliseGroupState, resolveStructPath, splitBinding, toNumber } from '../viewer_shared.mjs';
...
import { buildMuJoCoBundle as buildMuJoCoBundleCore, normaliseMuJoCoVirtualPath, parseMuJoCoDirectFileRefs } from '../xml_refs.mjs';
import { DEFAULT_VIEWER_STATE, applyGesture, applySpecAction, clamp01, createViewerStore, getControlBindingSpec, mergeBackendSnapshot, parseVector, prepareBindingUpdate, readControlValue, readPersistedSectionCollapsed, resolvePlayPanelId, setPlaySectionCollapsed, toBoolean, toggleAllPlaySections, writePersistedSectionCollapsed, installPanelSectionDblclickDelegation } from './state.mjs';
