...
const POINTER_ALIASES = {
  ...
  // Sites (model views)
  _mjwf_site_size_ptr: '_mjwf_model_site_size_ptr',
  _mjwf_site_type_ptr: '_mjwf_model_site_type_ptr',
  _mjwf_site_matid_ptr: '_mjwf_model_site_matid_ptr',
  _mjwf_site_bodyid_ptr: '_mjwf_model_site_bodyid_ptr',
  _mjwf_site_group_ptr: '_mjwf_model_site_group_ptr',
  _mjwf_site_rgba_ptr: '_mjwf_model_site_rgba_ptr',
  // Tendons (model views)
  _mjwf_tendon_width_ptr: '_mjwf_model_tendon_width_ptr',
  _mjwf_tendon_matid_ptr: '_mjwf_model_tendon_matid_ptr',
  _mjwf_tendon_group_ptr: '_mjwf_model_tendon_group_ptr',
  _mjwf_tendon_rgba_ptr: '_mjwf_model_tendon_rgba_ptr',
  _mjwf_mat_rgba_ptr: '_mjwf_model_mat_rgba_ptr',
  _mjwf_mat_emission_ptr: '_mjwf_model_mat_emission_ptr',
  _mjwf_mat_metallic_ptr: '_mjwf_model_mat_metallic_ptr',
  _mjwf_mat_reflectance_ptr: '_mjwf_model_mat_reflectance_ptr',
  _mjwf_mat_roughness_ptr: '_mjwf_model_mat_roughness_ptr',
  _mjwf_mat_shininess_ptr: '_mjwf_model_mat_shininess_ptr',
  _mjwf_mat_specular_ptr: '_mjwf_model_mat_specular_ptr',
  ...
  _mjwf_tex_type_ptr: '_mjwf_model_tex_type_ptr',
  _mjwf_tex_adr_ptr: '_mjwf_model_tex_adr_ptr',
  _mjwf_tex_width_ptr: '_mjwf_model_tex_width_ptr',
  _mjwf_tex_height_ptr: '_mjwf_model_tex_height_ptr',
  _mjwf_tex_nchannel_ptr: '_mjwf_model_tex_nchannel_ptr',
  _mjwf_tex_data_ptr: '_mjwf_model_tex_data_ptr',
  _mjwf_tex_colorspace_ptr: '_mjwf_model_tex_colorspace_ptr',
  ...
  _mjwf_eq_type_ptr: '_mjwf_model_eq_type_ptr',
  _mjwf_eq_obj1id_ptr: '_mjwf_model_eq_obj1id_ptr',
...
const COUNT_ALIASES = {
  ...
  _mjwf_ncam: '_mjwf_model_ncam',
  _mjwf_nlight: '_mjwf_model_nlight',
  _mjwf_nsite: '_mjwf_model_nsite',
  _mjwf_nsensor: '_mjwf_model_nsensor',
  _mjwf_ntendon: '_mjwf_model_ntendon',
  _mjwf_nwrap: '_mjwf_model_nwrap',
  _mjwf_data_nsensordata: '_mjwf_model_nsensordata',
  _mjwf_neq: '_mjwf_model_neq',
  _mjwf_nmat: '_mjwf_model_nmat',
  _mjwf_nmesh: '_mjwf_model_nmesh',
  _mjwf_ntex: '_mjwf_model_ntex',
  _mjwf_ntexdata: '_mjwf_model_ntexdata',
